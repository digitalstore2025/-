    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="22" cy="22" r="20" fill="#6C5CE7"/>
              <path d="M22 6C13.163 6 6 13.163 6 22s7.163 16 16 16c2.5 0 4.86-.58 6.96-1.6L22 29.6V6z" fill="#5F3DC4"/>
              <path d="M28.96 36.4A15.94 15.94 0 0038 22c0-8.837-7.163-16-16-16v23.6l6.96 6.8z" fill="#9775FA"/>
            </svg>
            <span className="text-2xl sm:text-3xl font-bold text-[#6C5CE7]">Praktika</span>
          </div>
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#7C3AED] via-[#8B5CF6] to-[#A78BFA] rounded-[2rem] lg:rounded-[3rem] overflow-hidden shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12 lg:gap-16 mb-12 lg:mb-16">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <svg width="32" height="64" viewBox="0 0 32 64" fill="none" className="opacity-30 hidden sm:block">
                    <path d="M6 12c2.5 4 4 8 5 13 0.5 5 0.5 10 -0.5 15M10 17c2 3.5 2.5 7 3 11 0 4.5 -0.5 9 -1.5 13M14 22c1 2.5 1.5 5.5 1.5 9 0 3.5 -1 7 -2 10" stroke="#E8DAFF" strokeWidth="2" strokeLinecap="round"/>
                  </svg>
                    ...
                    <div className="relative bg-gradient-to-b from-[#E5E5E5] to-[#D4D4D4] rounded-[2.7rem] overflow-hidden h-full">
                      ...
                      <div className="relative h-full pt-14 px-4 pb-4">
                        ...
                        <div className="flex items-center gap-1.5 mb-3">
                          <span className="text-gray-700 font-medium text-sm">Skye</span>
                        ...
                        {/* 3D Character Avatar */}
                        <div className="relative w-full aspect-square rounded-[1.5rem] overflow-hidden mb-4 bg-gradient-to-br from-[#E8E0D5] via-[#DDD5CA] to-[#D2CAC0] shadow-sm">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center">
                              ...
                              <div className="text-[9px] text-gray-500 font-medium">AI Tutor Avatar</div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-2.5 mb-16">
                          ...
                          <div className="flex justify-end">
                            <div className="bg-white rounded-[1.2rem] rounded-tr-md px-3.5 py-2.5 max-w-[88%] shadow-sm border border-gray-200">
                              ...
                              <span className="bg-[#EF4444] text-white px-2 py-0.5 rounded-md text-[13px] font-medium leading-tight">to speak</span>
                          ...
                          <div className="flex justify-start">
                            <div className="bg-[#8B5CF6] rounded-[1.2rem] rounded-tl-md px-3.5 py-2.5 max-w-[92%] shadow-md">
                        ...
                        <div className="absolute bottom-5 left-1/2 -translate-x-1/2">
                          <button className="w-16 h-16 bg-white rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.15)] flex items-center justify-center hover:scale-105 active:scale-95 transition-transform">
                            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                              <rect x="11" y="4" width="6" height="10" rx="3" fill="#8B5CF6"/>
                              <path d="M8 12v2c0 3.3 2.7 6 6 6s6-2.7 6-6v-2M14 20v4M10 24h8" stroke="#8B5CF6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                          </button>
                        </div>
                      </div>
